...
\titlePL{Analiza sygnatur kodu w mapowanej pamięci procesu}
\titleEN{Analysis of code signatures in mapped memory \\* of a process}


\shorttitlePL{Analiza sygnatur kodu w mapowanej pamięci procesu} % skrócona wersja tytułu jeśli jest bardzo długi
